...
class Chapter1Station5And6ImageMatchInnerScaleTest {
    ...
    fun chapter2PictureTuning() {
        ...
        assertEquals(1f, Chapter1Station5And6ImageMatchInnerScale.innerScale(LessonChoice("w_ש_2", "ש", "שולחן", 0)), 0f)
        assertEquals(1f, Chapter1Station5And6ImageMatchInnerScale.innerScale(LessonChoice("x", "ש", "שולחן", 0)), 0f)
