...
private val CaptionOverridesByChapterStationWord: Map<CaptionOverrideKey, Float> =
    mapOf(
        ...
        CaptionOverrideKey(chapterId = 3, stationId = 2, word = "היפופוטם") to (0.528f * 1.30f * 1.20f),
        CaptionOverrideKey(chapterId = 3, stationId = 2, word = "פיפופוטם") to (0.528f * 1.30f * 1.20f),
        CaptionOverrideKey(chapterId = 3, stationId = 2, word = "מוצץ") to (0.80f * 1.30f * 1.20f),
        ...
        CaptionOverrideKey(chapterId = 3, stationId = 2, word = "מכונית") to (0.81f * 1.20f),
        CaptionOverrideKey(chapterId = 3, stationId = 2, word = "ראש") to 1.20f,
        ...
        CaptionOverrideKey(chapterId = 6, stationId = 1, word = "תינוק") to (0.80f * 0.90f),
        CaptionOverrideKey(chapterId = 6, stationId = 1, word = "חלב") to (0.90f * 0.90f),
        CaptionOverrideKey(chapterId = 6, stationId = 1, word = "טוסט") to (0.95f * 0.80f),
