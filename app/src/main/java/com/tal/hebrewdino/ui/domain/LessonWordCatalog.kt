...
object LessonWordCatalog {
    ...
    val entries: List<LessonWordEntry> =
        listOf(
            ...
            LessonWordEntry("w_ג_5", "ג", "גג", 0xFF90A4AE.toInt(), tileRes = R.drawable.lesson_pic_gag),
            ...
            LessonWordEntry("w_ד_5", "ד", "דגל", 0xFFE57373.toInt(), tileRes = R.drawable.lesson_pic_degel),
            ...
            LessonWordEntry("w_ז_5", "ז", "זנב", 0xFFCE93D8.toInt(), tileRes = R.drawable.lesson_pic_zanav),
            ...
            LessonWordEntry("w_מ_6", "מ", "מעיל", 0xFF5C6BC0.toInt(), tileRes = R.drawable.lesson_pic_meil),
