...
object LessonWordCatalog {
    val entries: List<LessonWordEntry> =
        listOf(
            ...
            LessonWordEntry("w_ו_1", "ו", "ורד", 0xFF80D8FF.toInt()),
            LessonWordEntry("w_ו_2", "ו", "וילון", 0xFFFF8A65.toInt()),
            LessonWordEntry("w_ו_3", "ו", "וילה", 0xFF8E24AA.toInt()),
            LessonWordEntry("w_ו_4", "ו", "וופל", 0xFF00BFA5.toInt()),
