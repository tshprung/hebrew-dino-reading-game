...
object Season2NavKeys {
    ...
    /** After Season 2 Ch.7 St6 — navigate to the season-complete summary (every finish, including replay). */
    const val REQUEST_SEASON_COMPLETE_SUMMARY = "s2_request_season_complete_summary"
